...
from .vespec import VerificationElementIssue, get_subcomponents_ves, \
    build_ve_model
...
class TestCase(Schema):
    ...
    version = fields.Integer(load_from='majorVersion')
    status = fields.String(required=True)
    priority = fields.String(required=True)
    labels = fields.List(fields.String(), missing=list())
    test_script = fields.Method(deserialize="process_steps", load_from="testScript")
